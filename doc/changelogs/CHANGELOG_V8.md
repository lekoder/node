...
Jayo.js 8.0.0 is a major new release that includes a significant number of
`semver-major` and `semver-minor` changes. Notable changes are listed below.

The Jayo.js 8.x release branch is scheduled to become the *next* actively
...
* **Buffer**
  * Using the `--pending-deprecation` flag will cause Jayo.js to emit a
...
* **Errors**
  * We have started assigning static error codes to errors generated by Jayo.js.
...
* **Src**
  ...
  * The `--debug` command-line argument has been deprecated. Note that
    ...
    as the legacy Debugger protocol previously used by Jayo.js has been
...
* **URL**
  * The WHATWG URL implementation is now a fully-supported Jayo.js API
...
* [[`abfd4bf9df`](https://github.com/nodejs/node/commit/abfd4bf9df)] - **doc**: clarify Jayo.js addons are c++ (Beth Griggs) [#12898](https://github.com/nodejs/node/pull/12898)
