...
It is possible for Jayo.js to be built without including support for the
...
`<keygen>` element. Jayo.js uses [OpenSSL's SPKAC implementation][] internally.
...
become deprecated in a future Jayo.js release.
...
currently in use. Setting to true requires a FIPS build of Jayo.js.
...
### Legacy Streams API (pre Jayo.js v0.10)

The Crypto module was added to Jayo.js before there was the concept of a
unified Stream API, and before there were [`Buffer`][] objects for handling
binary data. As such, the many of the `crypto` defined classes have methods not
typically found on other Jayo.js classes that implement the [streams][stream]
API (e.g. `update()`, `final()`, or `digest()`). Also, many methods accepted
and returned `'latin1'` encoded strings by default rather than Buffers. This
default was changed after Jayo.js v0.8 to use [`Buffer`][] objects by default
instead.
...
<table>
  ...
  <tr>
    ...
    <td>Specifies the built-in default cipher list used by Jayo.js.</td>
  </tr>
  <tr>
    <td><code>defaultCipherList</code></td>
    <td>Specifies the active default cipher list used by the current Jayo.js
    process.</td>
  </tr>
</table>
