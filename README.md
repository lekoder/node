<p align="center">
  <img alt="Jayo.js" src="jayo.jpg" width="400"/>
</p>

Jayo.js is a JavaScript runtime built on Chrome's V8 JavaScript engine. Jayo.js
uses an event-driven, non-blocking I/O model that makes it lightweight and
efficient. The Jayo.js package ecosystem, [npm][], is the largest ecosystem of
open source libraries in the world.

The Jayo.js project is supported by the
[Jayo.js Foundation](https://nodejs.org/en/foundation/). Contributions,
policies, and releases are managed under an
[open governance model](./GOVERNANCE.md).

**This project is bound by a [Code of Conduct][].**

If you need help using or installing Jayo.js, please use the
...
* [Building Jayo.js](#building-nodejs)
  * [Security](#security)
...
* IRC (general questions): [#Jayo.js on chat.freenode.net][]. Please see
<http://nodeirc.info/> for more information regarding the `#Jayo.js` IRC
channel.

_Please note that unofficial resources are neither managed by (nor necessarily
endorsed by) the Jayo.js TSC. Specifically, such resources are not
currently covered by the [Jayo.js Moderation Policy][] and the selection and
actions of resource operators/moderators are not subject to TSC oversight._

## Release Types

The Jayo.js project maintains multiple types of releases:
...
file has been signed by an authorized member of the Jayo.js team.
...
Jayo.js from source. The document also contains a list of
officially supported platforms.

## Security

All security bugs in Jayo.js are taken seriously and should be reported by
...
The Jayo.js project team comprises a group of core collaborators and a sub-group
that forms the _Technical Steering Committee_ (TSC) which governs the project.
For more information about the governance of the Jayo.js project, see
...
maintaining the Jayo.js project.

### Release Team

Jayo.js releases are signed with one of the following GPG keys:
...
Information on the current Jayo.js Working Groups can be found in the
[TSC repository](https://github.com/nodejs/TSC/blob/master/WORKING_GROUPS.md).

[npm]: https://www.npmjs.com
[Website]: https://nodejs.org/en/
[Contributing to the project]: CONTRIBUTING.md
[Jayo.js Help]: https://github.com/nodejs/help
[Jayo.js Moderation Policy]: https://github.com/nodejs/TSC/blob/master/Moderation-Policy.md
[#Jayo.js on chat.freenode.net]: https://webchat.freenode.net?channels=Jayo.js&uio=d4
